...
export default function App() {
  ...
  React.useEffect(() => {
    setTicketsArray(() => {
      ...
      if(priceSortFromMax)//descending order
        resArray.sort((a, b) => parseFloat(b.price) - parseFloat(a.price)); 
      else//ascending order 
        resArray.sort((a, b) => parseFloat(a.price) - parseFloat(b.price)); 
      return resArray;
    });
    ...
    <div className="App">
      ...
      <div className="body">
        <div className="filters-body">
          ...
          <PriceSortFilter priceSortFromMax = {priceSortFromMax} setPriceSort = {setPriceSort}/>
        </div>
